...
@section('content')
    <div class="container mt-3 justify-content-center">
        ...
        <x-utility-button href="{{ route('showEditAdmin') }}" class="secondary" icon="fa-solid fa-arrow-left me-2">
            戻る
        </x-utility-button>

        <div class="form-contents">
            <form action={{ route('exeUpdateAdmin', $admin['id']) }} method="post">
                @csrf
                @method('patch')
                <table class="mt-3 mx-auto">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control @error('staff_code') is-invalid @enderror mt-5 ms-5" name="staff_code" value="{{ $admin['staff_code'] }}" id="staff_code">
                                @error('staff_code')
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control @error('name') is-invalid @enderror mt-5 ms-5" name="name" value="{{ $admin['name'] }}" id="name">
                                @error('name')
                                    <span class="invalid-feedback ms-5" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text"
                                    ...
                                    name="affiliation" value="{{ $admin['affiliation'] }}" id="affiliation">
                                @error('affiliation')
                                    <span class="invalid-feedback ms-5" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
