...
@section('content')
    <div class="container">
        ...
        @if (session('destroyErrorMessage'))
        ...
        <div class="my-3">
            <x-modal-and-delete-button type="button" buttonClass="danger" data-bs-toggle="modal" data-bs-target="#modal"
                icon="fa-solid fa-trash me-2" id="modal" title="確認：削除しようとしています" body="全職員のフィードバックを本当に削除しますか？"
