                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="form-select mt-5" name="role_id" id="role_id"
                                    ...
                                    @foreach (App\Consts\StaffPositionConsts::STAFF_LIST as $position => $num);
                    ...
                    <div class="form-item">
                        <tr>
                            ...
                            <td>
                                <input type="password" class="mt-5" name="password_confirmation" id="password_confirmation" required
